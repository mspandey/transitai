    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto flex w-full max-w-sm flex-1 flex-col px-5 py-12">
        ...
        <form onSubmit={handleLogin} className="mt-8 flex flex-col gap-4">
          <label className="label-mono">Username or ID<input type="email" required value={email} onChange={(event) => setEmail(event.target.value)} className="mt-2 w-full border-b border-border bg-transparent pb-3 text-base outline-none focus:border-signal" /></label>
